...
public class Principal {
    ...
    public static void main(String[] args) throws Exception {
        ...
        banco.recuperarDatosCuentasBancarias();
        ...
        while (!salir) {
            ...
            try {
                ...
                System.out.println("7. Eliminiar Cuenta");//se agrego eliminar cuenta
                ...
                switch (opcion) {
                    ...
                    case 8:
                        salir = true;
                        banco.guardarDatosCuentasBancarias();
    ...
    //metodo que mostrara la lista de cuentas al cargar el porgrama y al presionar la opcion 2
    public static void cargarDatosFichero(Banco banco) {
        String[] listaCuentas;
